...
export default function GoalsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-8 animate-fadeIn">
      ...
      {/* CREATE NEW DESTINATION MODAL (Full Screen on Mobile / Centered Dialog on Desktop) */}
      {showAddModal && (
        <div className="fixed inset-0 z-50 bg-background sm:bg-black/60 sm:backdrop-blur-xs flex items-center justify-center p-0 sm:p-4 animate-fadeIn overflow-y-auto">
          <div className="w-full h-full sm:h-auto sm:max-w-lg sm:rounded-2xl sm:border sm:border-border/80 bg-card p-5 sm:p-6 space-y-6 shadow-2xl overflow-y-auto flex flex-col justify-between sm:justify-start">
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                ...
                <button
                  ...
                  className="p-2 rounded-xl border border-border/80 bg-secondary/50 text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>

              <form id="create-destination-form" onSubmit={handleCreateDestination} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-border/80 bg-background px-4 py-3 text-sm font-medium text-foreground focus:outline-hidden focus:border-primary"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border/80 bg-background px-4 py-3 text-xs font-medium text-foreground focus:outline-hidden focus:border-primary"
                    />
                  </div>
                </div>
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-border/60 mt-auto">
              <button
                type="button"
                onClick={() => setShowAddModal(false)}
                className="flex-1 rounded-xl border border-border/80 bg-secondary/50 py-3 text-xs font-semibold text-foreground hover:bg-secondary transition-colors"
              >
                Cancel
              </button>
              <button
                type="submit"
                form="create-destination-form"
                className="flex-1 rounded-xl bg-primary py-3 text-xs font-semibold text-primary-foreground hover:opacity-95 shadow-xs transition-opacity"
              >
                Create Destination
              </button>
            </div>
